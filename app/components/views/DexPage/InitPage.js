...
export const InitPageContent = () => {
  ...
  return (
    <div>
    <T id="dex.newPassphrase" m="Please set a new passphrase for the DEX.  You may use the same passphrase as you use for your wallet, or chose a new one.  ** Note ** If you lose the DEX passphrase, you will be forced to create a new DEX account and pay your exchange fees again." />
